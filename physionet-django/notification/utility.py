...
RESPONSE_COMMENTS = {
    15: 'Some of the information on your application does not make sense. Please resubmit with the correct information.',
    14: 'It looks like you did not complete the correct CITI course. The correct course is "Data or Specimens Only Research". Please resubmit with the correct information.',
    13: 'You submitted the CITI Certificate instead of the Completion Report (it should include a list of courses and scores). Please resubmit with the correct report.',
    12: 'The HIPAA module is missing from your CITI completion report.',
    11: 'Please retake the CITI course paying particular attention to the section on HIPAA Privacy Protections.',
    10: 'The email on your CITI report does not match your application email. You can not share CITI training reports.',
    9: 'You list your research category as Industry Researcher but did not list an institution. Please update your institution or if you are not associated with an institution or select Independent Researcher as your research category.',
    8: 'You listed yourself as a Hospital Researcher but did not list an institution. Please resubmit with the correct information.',
    7: 'You listed yourself as a Student but did not list an institution. Please resubmit with the correct information.',
    6: '"Massachusetts Institute of Technology Affiliates" should not be listed as your institution. This is for the CITI course step only. Please resubmit with the correct information.',
    5: 'The name for your reference does not seem correct. Please resubmit with the correct information.',
    4: 'You listed yourself as a reference. Please resubmit with another valid reference.',
    3: 'The email address listed for your reference is not active (emails sent to this address are undelivered).',
    2: 'We cannot identify you or your reference in our web search. Can you resubmit and provide references to your publications, personal webpage, or associations with known organizations?',
    1: 'Access is provided to individuals. Your research summary suggests that data may be shared within the group. Please resubmit your application, making it clear that the Data Use Agreement will be followed. If your colleagues plan to access the data, then they will need to apply for access independently.',
    0: ''
}
